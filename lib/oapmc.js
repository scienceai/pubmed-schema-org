...
function _pkg(pmcid, ldpm, root, opts, callback){
  ...
  readTargzFiles(root, function(err, xml, files, mainArticleName, license){
    ...
    var inline = jats.inline($article);

    files2resources(ldpm, root, files, inline, mainArticleName, function(err, resources){
      if(err) return callback(err);
      ...
      _inline2imgBase64(files, inline, function(err, imgBase64){
...
function files2resources(ldpm, root, files, inline, mainArticleName, callback){  
