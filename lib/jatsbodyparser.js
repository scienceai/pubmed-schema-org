...
JatsBodyParser.prototype.article = function($node){
 ...
 */
JatsBodyParser.prototype.front = function($node){
 ...
 */
JatsBodyParser.prototype.back = function($node){
...
JatsBodyParser.prototype.floatGroup = function($node){
  return this.map($node, 'div');
};
...
JatsBodyParser.prototype.code = function($node){
...
JatsBodyParser.prototype.colgroup = function($node){
  var attrList = [
    {name: 'id', value: $node.getAttribute('id')}, 
...
JatsBodyParser.prototype.col = function($node){
  var attrList = [
    {name: 'id', value: $node.getAttribute('id')}, 
    {name: 'bgcolor', value: $node.getAttribute('bgcolor')},
    {name: 'span', value: $node.getAttribute('span')}
...
JatsBodyParser.prototype.ack = function($node){
  var attrList = [
    {name: 'id', value: $node.getAttribute('id')}, 
...
JatsBodyParser.prototype.glossary = function($node){
